...
---Practice 01---
SELECT * FROM [Employee] WHERE FirstName = 'Viktor';

SELECT * FROM [Employee] WHERE LastName LIKE 'S%';

SELECT * FROM [Employee] WHERE DateOfBirth > '1988-01-01';

SELECT * FROM [Employee] WHERE Gender = 'M';

SELECT * FROM [Employee] WHERE HireDate LIKE '1998-01%';

SELECT * FROM [Employee] WHERE LastName LIKE 'A%' AND HireDate LIKE '2019-01%';

---Practice 02---
SELECT * FROM [Employee] WHERE FirstName = 'Aleksandar';

SELECT * FROM [Employee] ORDER BY FirstName ASC; 

SELECT * FROM [Employee] WHERE Gender = 'm' ORDER BY HireDate, Id DESC;
